...
const body = JSON.stringify({ SourceText: 'The Industrial Revolution changed the world.', Source: 'auto', Target: 'zh', ProjectId: 0 });
...
console.log({ date, timestamp, region, action, version, body });
(async () => {
  try {
